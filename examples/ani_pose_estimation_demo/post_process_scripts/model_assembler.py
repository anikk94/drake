...
bin_model_path = "ani_model_library/ikea_bin/assets/solid_ikea_bin_for_simulation_v3.STL"
...
def read_input() -> list:
    ...
    f = open("examples/ani_pose_estimation_demo/results/part_poses/final_states_20251229_6.txt", 'r')
